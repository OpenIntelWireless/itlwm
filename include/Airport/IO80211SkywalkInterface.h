...
public:
    ...
    virtual bool enable(UInt);
    virtual bool disable(UInt);
    virtual SInt32 initBSDInterfaceParameters(ifnet_init_eparams *,sockaddr_dl **);
    virtual SInt32 prepareBSDInterface(ifnet_t, UInt);
    virtual SInt32 processBSDCommand(ifnet_t, UInt, void *);
    virtual SInt32 setInterfaceEnable(bool);
    virtual SInt32 setRunningState(bool);
    virtual IOReturn handleChosenMedia(UInt);
    virtual IOReturn getSupportedMediaArray(UInt *,UInt *);
